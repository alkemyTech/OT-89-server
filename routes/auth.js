...
router.post(
  "/login",
  body("email").isEmail().normalizeEmail().withMessage("Insert a valid email"),
  body("password")
    .isLength({ min: 6 })
...
router.post(
  ...
  body("firstName")
    ...
    .trim()
    .isEmpty()
    .withMessage("You have to declare your firstname")
    .escape(),
  // Validate lastname
  body("lastName")
    .not()
    .isEmpty()
    .withMessage("You have to declare your lastname")
    .trim()
    .escape(),
  // Validate email
  body("email")
